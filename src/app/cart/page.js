...
const Cart = () => {
  ...
  const pricePerItem = 89.0; // Set the price per item
  const shippingCost = 49.0; // Set the shipping cost
      ...
      <Container className=" mt-10">
        ...
        <div className="p-2 rounded-md mt-5 bg-white shadow block md:hidden">
          {counts.map((count, index) => (
            <div
              className="flex flex-wrap pt-2 mb-4 bg-white shadow p-2"
              key={index}
            >
              <div className="flex gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <h2 className="text-sm font-medium">
                    Dhs. <span>{pricePerItem.toFixed(2)}</span>.00 AED
                  </h2>
                  <h2 className="text-sm font-medium">
              ...
              <div>
                ...
                <p className="text-12 font-medium">
                  Dhs. <span>{totalPrice(index)}</span>.00 AED
                </p>
              </div>
            </div>
          ))}
        ...
        <div className=" flex-col mt-10 md:mt-20">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm">
                            <div className="flex gap-2 justify-center items-center">
                              <div className="border-2 p-2 flex justify-center items-center gap-1 w-28">
                                ...
                                />
                                <input
                                  className="w-14 hover:border hover:scale-105 text-center"
                                  type="text"
                                  value={count}
                                  readOnly
                                />
          ...
          <div className="text-end border-t-2 mt-10 pt-5 space-y-3">
            ...
            <div className="pt-3">
              <Link
                href={"/checkout"}
                className="bg-primary rounded-md text-white  w-80 p-3"
              >
                Process to Checkout
              </Link>
            </div>
